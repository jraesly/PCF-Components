...
export class Badge implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        ...
        return React.createElement<BadgeComponentProps>(BadgeComponent, {
            ...
            badgeText: undefinedIfEmpty(context.parameters.BadgeText),
            badgeSize: undefinedIfEmpty(context.parameters.BadgeSize),
            badgeWeight: undefinedIfEmpty(context.parameters.BadgeWeight),
            badgeColor: undefinedIfEmpty(context.parameters.BadgeColor),
            badgeBackgroundColor: undefinedIfEmpty(context.parameters.BadgeBackgroundColor),
            badgeBorderRadius: undefinedIfEmpty(context.parameters.BadgeBorderRadius),
            badgePosition: context.parameters.BadgePosition.raw,
            badgeOffsetX: valueOrUndefined(context.parameters.BadgeOffsetX),
            badgeOffsetY: valueOrUndefined(context.parameters.BadgeOffsetY),
            badgeBorderColor: undefinedIfEmpty(context.parameters.BadgeBorderColor),
            //badgeAlignment: undefinedIfEmpty(context.parameters.BadgeAlignment),
        });
    }
